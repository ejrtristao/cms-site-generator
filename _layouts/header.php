            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-12">
                    <div class="header-logo">
                        <a href="index.html">
                            <img src="./_resources/images/logo/logo.png" alt="Awesome Logo">
                        </a>
                    </div>
                </div>
...
<!--Page Title-->
<section class="page-title" style="background: url(_resources/images/resources/page-title.jpg);">
    <div class="container clearfix">
        <div class="title pull-left">
            <h2>
            <?php if(!empty($_SESSION['title-page'])) echo $_SESSION['title-page']; else  ''; ?>
            </h2>
        </div>
        <ul class="title-manu pull-right">
            <li><a href="index.php">Home</a></li>
            <li><i class="fa fa-angle-double-right" aria-hidden="true"></i></li>
            <li><?php if(!empty($_SESSION['sub-title-page'])) echo $_SESSION['sub-title-page']; else  ''; ?></li>
        </ul>
    </div>
</section>
<!--End Page Title-->